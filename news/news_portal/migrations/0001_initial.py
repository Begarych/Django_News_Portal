# Generated by Django 4.2.11 on 2024-04-22 14:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='news_portal.category')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='news_portal.post')),
            ],
        ),
        migrations.AddField(
            model_name='post',
